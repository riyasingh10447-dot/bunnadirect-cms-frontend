...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    if (!loading && !authorized) router.push("/admin");
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
            ...
            <div className="mt-4">
              <button
                ...
                className="inline-flex items-center gap-2 bg-teal-600 text-white px-4 py-2 rounded-md text-sm hover:opacity-95 transition"
              >
                Go to Articles
              </button>
            </div>
